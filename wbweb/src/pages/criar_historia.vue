            ...
            <div class="col-12">
                <div class="row justify-center" style="margin: 60px 0 0 0;">
                    <div class="col-12 col-md-auto">
                        <q-uploader
                            class="upload_image"
                            url="http://127.0.0.1:8000/dbm"
                            v-model="historia.caminho_capa"
                            color="transparent"
                            text-color="black"
                            flat
                            bordered
    ...
    data(){
        return {
            ...
            historia: {
                ...
                conteudo_adulto: '',
                caminho_capa: 'http://colorindonuvens.com/wp-content/uploads/2020/03/Wallpaper4k-Preto-ColorindoNuvens-6.jpg',
                tags: [],
                historia_finalizada: '',
                data_atualizacao: '',
                data_criacao: '',
