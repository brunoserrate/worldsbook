...
export default {
    ...
    computed : {
        internalLabel (){
            ...
            return this.label != '' ? this.label : 'Público alvo'
        ...
        carregarDados(){
            ...
            .then((response) => {
                ...
                for(let item of response.data.data){
                    that.items.push({label:item.publico,value:item.id})
                    that.filterItems.push({label:item.publico,value:item.id})
                }
            })
        },
